...
def banner():
    ...
    #print('=============SON OF KING==============')
    print(f'{lg}   Version: {w}1.6{lg} | Author: {w}BLACKMAMBA{rs}\n')
...
while True:
    ...
    print(lg+'[4] Update your Rex Scraper'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
        ...
        try:
            # https://raw.githubusercontent.com/SUKHPAL443/Rex/SUKHPAL443/version.txt
        ...
        if float(version.text) > 1.1:
            ...
            print(f'{lg}[i] Your Rex Scraper is already up to date')
            input('Press enter to go to main menu...')
    elif a == 5:
        clr()
        banner()
